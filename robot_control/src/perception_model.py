...
source_path = Path("C:\\Users\\Owner\\OneDrive - Universität Stuttgart\\2025_26_hiwi\\05_bio_sun_shade\\auto-bending-test\\data\\result\\experiment_piece_servo_test_01\\images\\20260803_171316")
...
def langsam_inference(root_path: Path, source_path):
    ...
    for img_path in source_path:
        ...
        text_prompt = "white bending specimen"
...
def yolo_inference(root_path: Path, source_path, model_path: Path):
    ...
    for img_path in source_path:
        ...
        results = model.predict(source=str(img_path), conf=0.1, save=True, show=False, device=device,
