...
------
    ...
    Right col : 5-panel interactive Plotly chart
...
from viewer.config                      import cfg, SRC_ROOT
from viewer.model.pose_data             import load_pose_data
from viewer.model.app_state             import ViewerState
from viewer.view.video                  import resolve_video_path
from viewer.controller.sidebar          import render_sidebar, render_metrics
from viewer.controller.left_panel       import render_left_panel
from viewer.controller.right_panel      import render_right_panel
from viewer.controller.overlay_page     import render_overlay_page
from viewer.controller.stream           import run_stream_loop

# ── ensure src/ is on the path for utilities imports ─────────────────────────
if str(SRC_ROOT) not in sys.path:
    sys.path.insert(0, str(SRC_ROOT))

from utilities import plot_utils   # imported here so it's available to right_panel
