...
Examples:
    python calibrate_camera.py intrinsic --camera-index 0 `
        --squares-x 7 --squares-y 9 --square-length-mm 25 --marker-length-mm 19

    python calibrate_camera.py extrinsic --camera-index 0 `
        --squares-x 7 --squares-y 9 --square-length-mm 25 --marker-length-mm 19 `
        --ground-z 0.0

    python calibrate_camera.py extrinsic --method marker --camera-index 0 `
        --marker-id 0 --marker-length-mm 100 --ground-z 0.0

    python calibrate_camera.py full --images-dir path/to/imgs `
        --squares-x 7 --squares-y 9 --square-length-mm 25 --marker-length-mm 19

    python calibrate_camera.py iphone-full --capture-rotate90 90 `
        --squares-x 7 --squares-y 9 --square-length-mm 25 --marker-length-mm 19
"""
import argparse
import sys
...
CALIB_DATA_DIR = (Path(__file__).resolve().parents[1] / "dataset" / "calib_data")
